...
# Use VST normalization for visualizing
...
pdf("Replication_Fig1B.pdf", width = 8, height = 10)
...
pdf("Replication_Fig1B_Targeted.pdf", width = 8, height = 10)
...
# 5. Save to PDF
pdf("Replication_Fig1C_Histones.pdf", width = 8, height = 8)
