...
The HISAT2 upregulated network (Figure 10, Left) is the extremely dense in connections. Genes such as Was, Btk, Rac2, Spi1, Dock2, Vav1, Ptprc, and Itgb2 connect multiple immune and cell activation pathways, indicating these components could be part of a signaling program that defines MEL cell identity.
