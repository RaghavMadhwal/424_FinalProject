...
pheatmap(mat_1c_scaled, breaks = my_breaks,# Using the -2 to 3 scale from before
         legend_breaks = c(-2, -1, 0, 1, 2, 3), cluster_rows = TRUE, cluster_cols = FALSE, # Keep MEL on left, MEL-R on right
...
ego_down <- enrichGO(gene = genes_down, OrgDb = org.Mm.eg.db, keyType = 'SYMBOL', ont = "BP", # Biological Process
