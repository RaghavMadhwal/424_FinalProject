...
As shown in the Downregulated cnetplot (Figure 9), this seems to be driven by a tightly interconnected cluster of histone-family genes (e.g., H1f2, H1f0, H2bc21). Therefore, the transcript-level resolution of the Salmon pipeline is more sensitive to downregulation of specific histone genes, compared to the HISAT2 alignment, which may mask them at the gene-level.
...
The HISAT2 upregulated network (Figure 10, Left) is extremely dense in connections. Genes such as Was, Btk, Rac2, Spi1, Dock2, Vav1, Ptprc, and Itgb2 connect multiple immune and cell activation pathways, indicating these components could be part of a signaling program that defines MEL cell identity.
