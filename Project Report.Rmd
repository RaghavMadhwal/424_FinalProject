...
```{r, echo=FALSE, fig.cap="Read counts, comparing Salmon vs. HISAT.", out.width="110%", fig.align="center"}

knitr::include_graphics("Combined Plots/Read_Counts.png")
```

```{r, echo=FALSE, fig.cap="PCA plot comparing Salmon to HISAT2 results.", out.width="110%", fig.align="center"}

knitr::include_graphics("Combined Plots/PCA.png")
```

```{r, echo=FALSE, fig.cap="Fig 1A Replication, genes ordered by adjusted p value for each method.", out.width="110%", fig.align="center"}

knitr::include_graphics("Combined Plots/Fig 1A.png")
```

```{r, echo=FALSE, fig.cap="Fig 1B Replication, top 50 genes from each method.", out.width="110%", fig.align="center"}

knitr::include_graphics("Combined Plots/Fig 1B.png")
```

```{r, echo=FALSE, fig.cap="Fig 1C Replication, histone gene expression.", out.width="110%", fig.align="center"}

knitr::include_graphics("Combined Plots/Fig 1C.png")
```

```{r, echo=FALSE, fig.cap="Cluster Profiler analysis with Go, down regulated / lost pathways.", out.width="110%", fig.align="center"}

knitr::include_graphics("Combined Plots/ClusterProfiler_Down.png")
```

```{r, echo=FALSE, fig.cap="Cluster Profiler analysis with Go, up regulated / gained pathways.", out.width="110%", fig.align="center"}

knitr::include_graphics("Combined Plots/ClusterProfiler_Up.png")
```

```{r, echo=FALSE, fig.cap="Gene network analysis with down regulated genes.", out.width="110%", fig.align="center"}

knitr::include_graphics("Combined Plots/Gene_Network_Down.png")
```

```{r, echo=FALSE, fig.cap="Gene network analysis with up regulated genes.", out.width="110%", fig.align="center"}
